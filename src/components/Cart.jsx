...
function Cart() {
  return (
    <div><section className="py-20 bg-light overflow-hidden">
          ...
          <div className="col-12 col-xl-8 mb-8 mb-xl-0">
            ...
            <div className="mb-12 py-6 border-top border-bottom">
              <div className="row align-items-center mb-6 mb-md-3">
                ...
                <div className="col-auto col-md-2">
                  <div className="d-inline-flex align-items-center px-4 fw-bold text-secondary border rounded-2">
                    <button className="btn px-0 py-2" fdprocessedid="ukvvwg">
                      <svg
                        width={12}
                        height={2}
                        viewBox="0 0 12 2"
                    ...
                    <input
                      ...
                      type="number"
                      placeholder={1}
                      fdprocessedid="buyddc"
                    />
                    <button className="btn px-0 py-2" fdprocessedid="1usyg9">
                      <svg
                        width={12}
                        height={12}
                        viewBox="0 0 12 12"
              ...
              <div className="row align-items-center">
                ...
                <div className="col-auto col-md-2">
                  <div className="d-inline-flex align-items-center px-4 fw-bold text-secondary border rounded-2">
                    <button className="btn px-0 py-2" fdprocessedid="7kpo5h">
                      <svg
                        width={12}
                        height={2}
                        viewBox="0 0 12 2"
                    ...
                    <input
                      ...
                      type="number"
                      placeholder={1}
                      fdprocessedid="lo7z38"
                    />
                    <button className="btn px-0 py-2" fdprocessedid="gloo6r">
                      <svg
                        width={12}
                        height={12}
                        viewBox="0 0 12 12"
